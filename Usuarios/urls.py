...
urlpatterns = [
    ...
    path('landing_admin/<int:usuario_id>/<int:isAdmin>/', views.menu, name='landing_admin'),
    ...
    path('evaluaciones_admin/<int:usuario_id>/<int:isAdmin>/', views.evaluaciones_admin, name='evaluaciones_admin'),
    path('evaluaciones_admin_ver/<int:usuario_id>/<str:rubrica_name>/<int:isAdmin>/', views.evaluaciones_admin_ver,
         name='evaluaciones_admin_ver'),
